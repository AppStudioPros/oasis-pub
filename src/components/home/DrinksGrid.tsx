...
function Tile({ tile, i }: { tile: typeof TILES[0]; i: number }) {
  return (
    <motion.div
      key={tile.label}
    ...
    >
      ...
      >
        <div className="relative bg-white aspect-[4/3] border-2 border-black shadow-[5px_5px_0_0_#000] group-hover:shadow-[7px_7px_0_0_#000] group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 transition-all overflow-hidden p-4 md:p-5 flex flex-col justify-between">
          {/* Noise texture */}
          ...
          {/* Oversized icon */}
          <div className="absolute -top-6 left-[70%] -translate-x-1/2 w-64 h-64 md:w-72 md:h-72 pointer-events-none z-0">
            <Image
              src={tile.icon}
              alt={tile.label}
              fill
